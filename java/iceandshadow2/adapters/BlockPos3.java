...
public class BlockPos3 extends BlockPos2 {
	...
	public Block block(World w, Block newBlock) {
		return block(w, y, newBlock);
	}

	public Block block(World w, Block newBlock, int newMeta) {
		return block(w, y, newBlock, newMeta);
	}
