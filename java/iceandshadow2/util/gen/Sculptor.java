...
public class Sculptor {
	 ...
	 * @param meta
	 */
	public static void cube(World world, int xLow, int yLow, int zLow, int xHigh, int yHigh, int zHigh, Block bl, int meta) {
	 ...
	 */
	public static void walls(World world, int xLow, int yLow, int zLow, int xHigh, int yHigh, int zHigh, Block bl, int meta) {
		for(int yit = yLow; yit <= yHigh; ++yit) {
	 ...
	 * @param zdeltaThe number of blocks to remove before or after the specified z coordinate.
	 */
	public static void corners(World world, int xLow, int yLow, int zLow, int xHigh, int yHigh, int zHigh, Block bl, int meta) {
		for(int yit = yLow; yit <= yHigh; ++yit) {
	 ...
	 * @param y
	 * @param z
	 * @param xdelta The number of blocks to extrude before or after the specified x coordinate.
	 * @param ydown The number of blocks to fill upward from.
	 * @param zdelta The number of blocks to extrude before or after the specified z coordinate.
	 */
	public static void terrainFlatten(World world, int xLow, int y, int zLow, int xHigh, int yDown, int zHigh) {
		for(int xit = xLow; xit <= xHigh; ++xit) {
			for(int zit = zLow; zit <= zHigh; ++zit) {
				...
				Block fillah = world.getBiomeGenForCoords(xit, zit).fillerBlock;
