...
public class RenderThrowingKnife extends Render
{
    ...
    public void renderKnife(EntityThrowingKnife knife, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        GL11.glRotatef(knife.prevRotationYaw + (knife.rotationYaw - knife.prevRotationYaw) * par9 - 90.0F, 0.0F, 1.0F, 0.0F);
        GL11.glRotatef(knife.prevRotationPitch + (knife.rotationPitch - knife.prevRotationPitch) * par9, 0.0F, 0.0F, 1.0F);
        ...
        float var21 = (float)knife.arrowShake - par9;
    ...
    {
        this.renderKnife((EntityThrowingKnife)par1Entity, par2, par4, par6, par8, par9);
    }
