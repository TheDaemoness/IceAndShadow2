...
public class RenderIceArrow extends Render
{
    ...
    private static ResourceLocation icearrow_resourceloc = new ResourceLocation("iceandshadow2:textures/entity/nyxicebolts.png");
    
    public void renderArrow(EntityIceArrow par1EntityArrow, double par2, double par4, double par6, float par8, float par9)
    {
	...
	protected ResourceLocation getEntityTexture(Entity entity) {
		return this.icearrow_resourceloc;
	}
}
