...
public class IaSDamageSources {
	public static DamageSource dmgStone, dmgVines, dmgPoisonwood, dmgStalagmite, dmgGatestone, dmgXpAltar, dmgFreezing, dmgDrain;
	...
	public static void init() {
		...
		IaSDamageSources.dmgGatestone = new IaSDamageSource("IceAndShadow2.nyxGatestoneDamage", 0.9F, true)
				.setMagicDamage();
		IaSDamageSources.dmgXpAltar = new IaSDamageSource("IceAndShadow2.nyxXpAltarDamage", 0.1F, true)
				.setMagicDamage().setDamageIsAbsolute();
