...
public abstract class IaSGrenadeLogic {
	 ...
	 * 
	 * @param cooked How long the grenade has been held in-hand for. If looking to
	 *               manipulate the base fuse time, please use the other
	 *               constructor.
	 */
	 ...
	 * 
	 * @param fuse   How long the fuse lasts for. If passed a negative or zero
	 *               value, the grenade will detonate that many ticks after impact.
	 * @param cooked How long the grenade has been held in-hand for. Ignored if the
	 *               fuse starts on impact.
	 */
	...
	/**
	 * Returns this grenade logic's id with IaS2. A value of -1 indicates that this
	 * grenade type is unregistered.
	 */
	...
	/**
	 * DO NOT CALL THIS YOURSELF. Doing so prevents the grenade logic type from
	 * being registered with IaS2.
	 */
