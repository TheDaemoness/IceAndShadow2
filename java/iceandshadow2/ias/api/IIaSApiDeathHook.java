...
public interface IIaSApiDeathHook {
	/**
	 * Called if the relevant item function returned one of the ALTER actions. If
	 * ALTER_BOTH had been returned, willDrop will be false.
	 *
	 * @param willDrop Indicates if this item stack will be dropped or not.
	 ...
	 * @return The action the death system should take. Returning default will keep
	 *         the item, unless another handler returns non-default.
	 */
	 ...
	 * @param pwai The player.
	 * @param is   The item stack in question.
	 * @return The action the death system should take. Returning default will call
	 *         getActionInventory().
	 */
	 ...
	 * @param pwai The player.
	 * @param is   The item stack in question.
	 * @return The action the death system should take. Returning default will drop
	 *         the item, unless another handler returns non-default.
	 */
	 ...
	 *
	 * @param pwai The player.
	 * @param is   The item stack being processed.
