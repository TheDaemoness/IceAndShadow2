 ...
 * These functions are called once each time a signal begins, and once each time a signal ends.
 * The data object may be null, and it may differ between the start and stop call.
 */
