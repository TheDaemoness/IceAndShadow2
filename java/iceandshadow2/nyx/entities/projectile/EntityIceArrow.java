	...
	public void onUpdate() {
		...
		if (var4 != null)
			if (var4.entityHit != null) {
				 ...
				 * this.motionZ = (double) ((float) (var4.hitVec.zCoord - this.posZ)); var20 =
				 ...
				 * (double) var20 0.05000000074505806D; this.posY -= this.motionY / (double)
				 * var20 0.05000000074505806D; this.posZ -= this.motionZ / (double) var20
