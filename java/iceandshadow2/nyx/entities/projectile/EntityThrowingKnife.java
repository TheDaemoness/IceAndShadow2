...
public class EntityThrowingKnife extends IaSEntityKnifeBase {
	...
	public EntityThrowingKnife(World w, EntityLivingBase shooter, EntityLivingBase target, float vel, float acc,
		...
		final double var8 = target.posY + target.getEyeHeight() - 0.699999988079071D - this.posY;
		...
		if (var12 >= 1.0E-7D) {
			...
			setLocationAndAngles(shooter.posX + var16, this.posY, shooter.posZ + var18, var14, var15);
	...
	public EntityThrowingKnife(World w, EntityLivingBase shooter, float vel, ItemStack is) {
		...
		setThrowableHeading(this.motionX, this.motionY, this.motionZ, vel * 1.5F, 1.0F);
	}
	...
	public void doDrop(IaSToolMaterial mat) {
		if (!this.worldObj.isRemote) {
			final EntityItem drop = new EntityItem(this.worldObj, this.posX, this.posY, this.posZ,
	...
	public void onUpdate() {
		...
		if (var16 != null) {
			...
			if (var2 != null && var2.isVecInside(Vec3.createVectorHelper(this.posX, this.posY, this.posZ))) {
				...
				this.worldObj.playSoundAtEntity(this, mat.getKnifeMissSound(),
			...
			if (var4.entityHit != null && var4.entityHit != this.shootingEntity) {
				...
				if (var4.entityHit.attackEntityFrom(var21, var23)) {
					...
					if (var4.entityHit instanceof EntityLiving) {
						...
						if (var26 > 0.0F) {
							var4.entityHit.addVelocity(this.motionX * knockbackStrength * 0.6000000238418579D / var26,
									0.1D * knockbackStrength,
									this.motionZ * knockbackStrength * 0.6000000238418579D / var26);
						}
				...
				if (this.inTile != null) {
					...
					this.worldObj
							.playSoundAtEntity(this, mat.getKnifeMissSound(),
									(float) (var4.hitVec.lengthVector() / 5.0F > 1.0 ? 1.0F
											: var4.hitVec.lengthVector() / 5.0F),
									1.6F / (this.rand.nextFloat() * 0.2F + 0.4F));
