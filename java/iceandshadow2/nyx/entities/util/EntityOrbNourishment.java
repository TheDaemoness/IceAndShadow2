...
public class EntityOrbNourishment extends EntityXPOrb {
	...
	public EntityOrbNourishment(World w, double x, double y, double z,
			int amount) {
    ...
    public void onCollideWithPlayer(EntityPlayer pl)
    {
        if (!this.worldObj.isRemote)
        {
            ...
            {
                pl.xpCooldown = 5;
                this.worldObj.playSoundAtEntity(pl, "random.orb", 0.1F, 0.5F * ((this.rand.nextFloat() - this.rand.nextFloat()) * 0.7F + 1.8F));
