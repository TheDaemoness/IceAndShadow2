...
public class EntityTransmutationCountdown extends Entity {
	...
	public void onUpdate() {
		...
		// Do you think I care about code duplication in this project? :P
		if (age == 0) {
			IaSFxManager.spawnParticle(worldObj, "cortraSmoke", x + 0.2 + worldObj.rand.nextDouble() / 10, y + 0.4,
					z - 0.1, 0, 0, 0, false, false);
			IaSFxManager.spawnParticle(worldObj, "cortraSmoke", x + 0.2 + worldObj.rand.nextDouble() / 10, y + 0.4,
					z + 1.1, 0, 0, 0, false, false);
			IaSFxManager.spawnParticle(worldObj, "cortraSmoke", x - 0.1, y + 0.4,
					z + 0.2 + worldObj.rand.nextDouble() / 10, 0, 0, 0, false, false);
			IaSFxManager.spawnParticle(worldObj, "cortraSmoke", x + 1.1, y + 0.4,
					z + 0.2 + worldObj.rand.nextDouble() / 10, 0, 0, 0, false, false);
			IaSFxManager.spawnParticle(worldObj, "cortraSmoke", x + 0.7 + worldObj.rand.nextDouble() / 10, y + 0.4,
					z - 0.1, 0, 0, 0, false, false);
			IaSFxManager.spawnParticle(worldObj, "cortraSmoke", x + 0.7 + worldObj.rand.nextDouble() / 10, y + 0.4,
					z + 1.1, 0, 0, 0, false, false);
			IaSFxManager.spawnParticle(worldObj, "cortraSmoke", x - 0.1, y + 0.4,
