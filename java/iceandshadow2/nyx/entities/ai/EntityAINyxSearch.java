...
public class EntityAINyxSearch extends EntityAIBase {
	...
	public void startExecuting() {
		...
		this.taskOwner.getNavigator().tryMoveToEntityLiving(target, ((IIaSMobGetters)this.taskOwner).getMoveSpeed());
	}
	...
	public boolean continueExecuting() {
		++seen;
		return seen < 125 && !((IIaSSensate)this.taskOwner).getSense().canSense(target);
	}
