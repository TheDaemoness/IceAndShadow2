...
public class NyxItemPotion extends IaSBaseItemMulti {
	...
	static {
		...
		for (final Potion p : Potion.potionTypes) {
			if (p == null) {
				continue;
			}
	...
	public String getItemStackDisplayName(ItemStack is) {
		final String original = super.getItemStackDisplayName(is);
	...
	public int getColorFromItemStack(ItemStack is, int pass) {
		return pass > 0 ? super.getColorFromItemStack(is, pass) : getColorFromDamage(is.getItemDamage());
	}
