...
public class NyxItems {
	...
	public static void init() {
		NyxItems.teleportCrystal = new NyxItemTeleportCrystal("TeleportCrystal")
		.register().setCreativeTab(IaSCreativeTabs.misc);
		NyxItems.seedObsidian = new NyxItemSeedObsidian("SeedObsidian").register()
				.setCreativeTab(IaSCreativeTabs.misc);
		NyxItems.nifelhiumPowder = new NyxItemNifelhiumPowder("NifelhiumPowder")
				.register().setCreativeTab(IaSCreativeTabs.resources);
		NyxItems.bloodstone = new NyxItemBloodstone("Bloodstone").register()
				.setCreativeTab(IaSCreativeTabs.resources);
		NyxItems.navistraShard = new NyxItemNavistraShard("NavistraShard").register()
				.setCreativeTab(IaSCreativeTabs.resources);
		NyxItems.cortra = new NyxItemCortra("Cortra").register()
				.setCreativeTab(IaSCreativeTabs.resources);
		NyxItems.exousium = new NyxItemExousium("Exousium").register().setCreativeTab(
				IaSCreativeTabs.resources);
		NyxItems.devora = new NyxItemDevora("Devora").register().setCreativeTab(
				IaSCreativeTabs.resources);
		NyxItems.exousicIceShard = new NyxItemExousicIce("ExousicIceShard").register().setCreativeTab(
				IaSCreativeTabs.resources);
		NyxItems.draconium = new NyxItemDraconium("Draconium").register()
				.setCreativeTab(IaSCreativeTabs.resources);
		NyxItems.echirIngot = new NyxItemIngot("EchirIngot").register()
				.setCreativeTab(IaSCreativeTabs.resources);
		...
		NyxItems.poisonFruit = new NyxItemPlumPoison("PoisonFruit").register()
				.setCreativeTab(IaSCreativeTabs.resources);
		NyxItems.poisonFruitFertile = new NyxItemPlumPoisonFertile("PoisonFruitFertile")
				.register().setCreativeTab(IaSCreativeTabs.resources);
		...
		NyxItems.boneSanctified = new NyxItemBoneSanctified("SanctifiedBone").register()
				.setCreativeTab(IaSCreativeTabs.resources);
		NyxItems.vineBundle = new NyxItemVineBundle("VineBundle").register()
				.setCreativeTab(IaSCreativeTabs.resources);
		NyxItems.bread = new NyxItemFoodBread("Bread").register()
				.setCreativeTab(CreativeTabs.tabFood);
		NyxItems.cookie = new NyxItemFoodCookie("Cookie").register()
				.setCreativeTab(CreativeTabs.tabFood);
		NyxItems.echirShears = new IaSItemShears(EnumIaSModule.NYX, "EchirShears")
				.register().setCreativeTab(IaSCreativeTabs.tools);
		NyxItems.icicle = new NyxItemIcicle("Icicle").register().setCreativeTab(
				IaSCreativeTabs.resources);
		NyxItems.page = new NyxItemLorePage("Page").register().setCreativeTab(
				IaSCreativeTabs.misc);
		NyxItems.rope = new NyxItemRope("Rope").register().setCreativeTab(
		...
		NyxItems.heat = new NyxItemHeat("Heat").register().setCreativeTab(
				IaSCreativeTabs.misc);
		NyxItems.crystalVial = new NyxItemCrystalVial("CrystalVial").register()
				.setCreativeTab(IaSCreativeTabs.tools);
		NyxItems.extractorPoison = new NyxItemExtractorPoison("ExtractorPoison").register()
				.setCreativeTab(IaSCreativeTabs.tools);
		NyxItems.resin = new NyxItemPhantomResin("PhantomResin").register()
				.setCreativeTab(IaSCreativeTabs.resources);
