...
public class NyxBiomes {
	...
	public static void init() {
		...
		nyxMesas = new NyxBiome(IaSFlags.biome_id_nyxMesas, true, 2.5F, 1.0F,
	...
	public static void registerBiomes() {
		BiomeDictionary.registerBiomeType(nyxLowMountains, Type.COLD,
				Type.SPARSE, Type.DEAD, Type.DRY, Type.SNOWY, Type.WASTELAND,
				Type.MOUNTAIN);
		BiomeDictionary.registerBiomeType(nyxHighMountains, Type.COLD,
				Type.SPARSE, Type.DEAD, Type.DRY, Type.SNOWY, Type.WASTELAND,
				Type.MOUNTAIN);

		BiomeDictionary.registerBiomeType(nyxHills, Type.COLD, Type.SPARSE,
				Type.DEAD, Type.DRY, Type.SNOWY, Type.WASTELAND, Type.MOUNTAIN);
		BiomeDictionary.registerBiomeType(nyxMesas, Type.COLD, Type.SPARSE,
				Type.DEAD, Type.DRY, Type.SNOWY, Type.WASTELAND, Type.MESA);

		BiomeDictionary.registerBiomeType(nyxHillForest, Type.COLD, Type.DENSE,
				Type.CONIFEROUS, Type.DRY, Type.SNOWY, Type.FOREST,
				Type.MOUNTAIN);
		BiomeDictionary.registerBiomeType(nyxMesaForest, Type.COLD, Type.DRY,
				Type.CONIFEROUS, Type.SNOWY, Type.MESA);

		BiomeDictionary.registerBiomeType(nyxRugged, Type.COLD, Type.SPARSE,
				Type.DEAD, Type.DRY, Type.SNOWY, Type.WASTELAND, Type.MOUNTAIN,
				Type.SPOOKY);

		BiomeDictionary.registerBiomeType(nyxInfested, Type.COLD, Type.DENSE,
