...
public class GenRuinsGatestoneCache extends GenRuins {
	...
	public void rewardPass(World var1, Random var2, int x, int y, int z) {
		...
		int chestcontentamount = 12 + var2.nextInt(6);
		for (byte i = 0; i < chestcontentamount; ++i) {
			...
			// Knives or armor!
				...
				if(var2.nextInt(3) == 0) {
					...
					case 0:
					case 1:
						itemz = new ItemStack(IaSTools.armorEchir[1]); break;
					case 2:
					case 3:
						itemz = new ItemStack(IaSTools.armorEchir[2]); break;
					case 4:
		...
		chestent.setInventorySlotContents(1+var2.nextInt(chestent.getSizeInventory()-1), new ItemStack(NyxItems.draconium));
