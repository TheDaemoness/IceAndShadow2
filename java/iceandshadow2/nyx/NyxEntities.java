...
public class NyxEntities {
	...
	public static void init(IceAndShadow2 owner) {
		...
		EntityRegistry.registerModEntity(EntityCosmeticShadowRiser.class, "nyxCosmeticShadowRiser", 9, owner, 40, 1,
				true);

		EntityRegistry.registerModEntity(EntityWightTeleport.class, "nyxProjectileWightTeleport", 10, owner, 80, 2,
				true);

		EntityRegistry.registerModEntity(EntityNyxWightToxic.class, "nyxMobWightToxic", 11, owner, 60, 1, true);
		NyxEntities.registerEntityEgg(EntityNyxWightToxic.class, 0x004400, 0xaaffaa);

		EntityRegistry.registerModEntity(EntityPoisonBall.class, "nyxProjectilePoisonBall", 12, owner, 40, 2, true);

		EntityRegistry.registerModEntity(EntityOrbNourishment.class, "nyxEntityOrbNourishment", 13, owner, 60, 1, true);
	}
