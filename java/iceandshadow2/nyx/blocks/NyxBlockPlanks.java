...
public class NyxBlockPlanks extends IaSBaseBlockMulti implements IIaSNoInfest {
	...
	public void onBlockClicked(World par1World, int par2, int par3, int par4,
		...
		if (dmg == 1)
			NyxBlocks.infestLog.onBlockClicked(par1World, par2, par3, par4,
					par5EntityPlayer);
		else
			NyxBlocks.poisonLog.onBlockClicked(par1World, par2, par3, par4,
					par5EntityPlayer);
	}
	...
	public void onEntityCollidedWithBlock(World par1World, int par2, int par3,
		...
		final int dmg = par1World.getBlockMetadata(par2, par3, par4);
		if (dmg == 1) {
			NyxBlocks.infestLog.onEntityCollidedWithBlock(par1World, par2,
